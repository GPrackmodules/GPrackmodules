...
**AB8** is a module in the GPaudio plugin for VCV Rack 2

![AB8 Module](AB8.png "The AB8 Module") &nbsp; &nbsp; &nbsp;
![AB8 Module](AB8-dark.png "The AB8 Module")
...
To the right of the A/B display, there is a CV output that reflects the current state of the A/B switch.
...
carried from the selected input to the output ports.
